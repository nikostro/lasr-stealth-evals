...
eval-test:
	$(INSPECT_EVAL_COMMON) --limit 2 -T monitor_model openrouter/openai/gpt-4.1-mini -T turns=5 -T use_hint=False -T use_justification=True -T is_cot_monitored=True -T generation_strategy=2
