...
from scripts.prompts import Protocol, Ticket, prompt_template, protocols
...
if __name__ == "__main__":
    generate_tickets(n_tickets=N_TICKETS, output_file=OUTPUT_FILE)