...
from lasr_stealth_evals.financial.channels import MessagingChannels
...
class Environment():
    ...
    def __init__(self, traders: List[str], platform: TradingPlatform, penalty_fractions: Dict[int, float], logger: Logger):
    ...
    # def spoof_buy(self, agent_id: str, asset_name: str, quantity: int) -> Dict[str, Any]:
    ...
    def buy(self, agent_id: str, asset_name: str, quantity: int) -> Dict[str, Any]:
